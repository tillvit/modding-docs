...
export const ActorLib = () =>
	createActorLuaLib(Actor, {
		...
		diffuseblink: { params: [] },
		diffusebottomedge: { params: [] },
		diffusecolor: { params: [] },
		diffuseleftedge: { params: [] },
		diffuselowerleft: { params: [] },
		diffuseramp: { params: [] },
		diffuserightedge: { params: [] },
		diffuseshift: { params: [] },
		diffusetopedge: { params: [] },
		diffuseupperleft: { params: [] },
		diffuseupperright: { params: [] },
		Draw: { params: [] },
		...
		fadetop: { params: ['FArg'] },
		finishtweening: { params: [] },
		get_tween_uses_effect_delta: { params: [] },
		GetAbsoluteDestX: { params: [] },
		GetAbsoluteDestY: { params: [] },
		GetAbsoluteX: { params: [] },
		GetAbsoluteY: { params: [] },
		getaux: { params: [] },
		GetBaseZoomX: { params: [] },
		...
		GetDestZ: { params: [] },
		GetDiffuse: { params: [] },
		GetDiffuseAlpha: { params: [] },
		GetEffectDelta: { params: [] },
		geteffectmagnitude: { params: [] },
		GetEffectRotationX: { params: [] },
		GetEffectRotationY: { params: [] },
		GetEffectRotationZ: { params: [] },
		GetFakeParent: { params: [] },
		GetGlow: { params: [] },
		GetHAlign: { params: [] },
		GetHeight: { params: [] },
		GetHoldLength: { params: [] },
		GetName: { params: [] },
		GetNumStates: { params: [] },
		GetNumWrapperStates: { params: [] },
		GetParent: { params: [] },
		GetRotAfterZoom: { params: [] },
		getrotation: { params: [] },
		GetRotationX: { params: ['FArg'] },
		GetSecsIntoEffect: { params: [] },
		GetSkewAfterZoomRot: { params: [] },
		GetSkewX: { params: ['BIArg'] },
		GetSkewY: { params: ['BIArg'] },
		GetTweenTimeLeft: { params: [] },
		GetVAlign: { params: [] },
		GetVisible: { params: [] },
		GetWidth: { params: [] },
		...
		GetZoomedHeight: { params: [] },
		GetZoomedWidth: { params: [] },
		...
		RunCommandsRecursively: { params: [] },
		scaletocover: { params: ['FArg', 'FArg', 'FArg', 'FArg'] },
		scaletofit: { params: ['FArg', 'FArg', 'FArg', 'FArg'] },
		set_tween_uses_effect_delta: { params: [] },
		SetFakeParent: { params: [] },
